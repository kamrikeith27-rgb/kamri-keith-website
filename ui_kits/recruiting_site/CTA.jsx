...
function CTA({ onContact }) {
  ...
  return (
    <section style={{ position: 'relative', background: KK.red, color: '#fff', overflow: 'hidden', minHeight: 340 }}>
      <img data-cta-cutout src="../../assets/photos/kamri-cutout.webp" alt="Kamri Keith" style={{ position: 'absolute', right: 'clamp(-30px, 4vw, 100px)', bottom: '-40px', height: 'auto', width: 'clamp(180px, 28vw, 320px)', objectFit: 'contain', objectPosition: 'center bottom', filter: 'drop-shadow(-14px 0 26px rgba(15,18,22,.28))', pointerEvents: 'none' }} />
